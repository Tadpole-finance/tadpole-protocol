...
contract Tad is Ownable {
    /// @notice EIP-20 token name for this token
    string public constant name = "Tadpole";
     ...
     */
    function mint(address account, uint rawAmount) public onlyOwner returns (bool) {
    ...
    function _transferTokens(address src, address dst, uint96 amount) internal {
        ...
        if(src != address(0)) balances[src] = sub96(balances[src], amount, "Comp::_transferTokens: transfer amount exceeds balance");
